                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-4">
                        ...
                        <button type="button" wire:click="deleteConfirm('deleteSelected')" wire:loading.attr="disabled"
                            ...
                            class="inline-flex items-center px-4 py-2 text-xs text-red-500 uppercase bg-red-200 rounded-md border border-transparent hover:text-red-700 hover:bg-red-300 disabled:opacity-50 disabled:cursor-not-allowed">
                            Delete Selected
                        </button>
