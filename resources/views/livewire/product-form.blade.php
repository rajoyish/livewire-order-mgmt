                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div>
                            ...
                            <x-text-input wire:model.defer="product.name" id="name" class="block mt-1 w-full"
                                type="text" />
                        ...
                        <div class="mt-4">
                            ...
                            <div wire:ignore>
                                <textarea wire:model.defer="product.description" data-description="@this" id="description"
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input wire:model.defer="product.price" type="number" min="0" step="0.01"
